...
class AVFoundationVideoPlayerApi {
  ...
  Future<void> setExternalPlayback(bool allowsExternalPlayback) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setExternalPlayback$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
    ...
    final List<Object?>? __pigeon_replyList = await __pigeon_channel
        .send(<Object?>[allowsExternalPlayback]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<bool> getExternalPlaybackActive(int textureId) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.getExternalPlaybackActive$__pigeon_messageChannelSuffix';
